# Enterprise-Registration-Data-of-Chinese-Mainland_CSV-branch

CSV 数据保存在 [CSV](https://github.com/imhuster/Enterprise-Registration-Data-of-Chinese-Mainland/tree/csv) 分支中。

CSV 的格式为：企业名称、统一社会信用代码、注册日期、企业类型、法人代表、注册资金、经营范围、所在省份、地区、注册地址，编码为 UTF-8。

最新数据会不定期进行更新。

The CSV data is located at the branch of [CSV](https://github.com/imhuster/Enterprise-Registration-Data-of-Chinese-Mainland/tree/csv) .

The order of 10 items in CSV are : 

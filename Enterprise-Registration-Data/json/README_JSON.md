# Enterprise-Registration-Data-of-Chinese-Mainland_JSON-branch

JSON 数据保存在 [JSON](https://github.com/imhuster/Enterprise-Registration-Data-of-Chinese-Mainland/tree/json) 分支中。
...
The JSON data is located at the branch of [JSON](https://github.com/imhuster/Enterprise-Registration-Data-of-Chinese-Mainland/tree/json) .

The record in the JSON file is represented as below:
